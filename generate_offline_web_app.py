      ...
      <div class="calc-grid">
        <div class="calc-form">
          ...
          <div class="card" id="cardSalary">
            ...
            <div id="salaryAlertAge" style="display:none; color:var(--warning); font-size:13px; font-weight:700; margin-top:8px; background:#FFFBEB; padding:8px; border:1px solid var(--warning);"></div>
          </div>
  ...
  <script>
    ...
    function handleCategoryChange() {{
      ...
      if (cat === "1a" || cat === "1b") {{
        salSel.innerHTML = isId ? `
          ...
          <option value="20">¥6.000.000 hingga kurang dari ¥7.000.000 (20 poin - hanya usia &lt;40 thn)</option>
        ...
        ` : `
          ...
          <option value="20">¥6,000,000 to less than ¥7,000,000 (20 pts - &lt;40 yrs old only)</option>
    ...
    function calculatePoints() {{
      ...
      if (salVal === "disqualify") {{
        ...
        if (salAlert) salAlert.style.display = "none";
        pSalary = +salVal || 0;
        let ageMismatchMsg = "";
        if (cat === "1a" || cat === "1b") {{
          const agePoints = +document.getElementById("calcAge").value;
          if (pSalary === 25 && agePoints < 5) {{
            pSalary = 0;
            ageMismatchMsg = isId ? 
              "Peringatan Batas Usia: Rentang gaji ¥7.000.000 – ¥8.000.000 (25 poin) memerlukan usia di bawah 40 tahun (0 poin untuk usia 40+)." :
              "Age Restriction Notice: The ¥7,000,000 – ¥8,000,000 bracket (25 pts) requires age under 40 (0 pts for age 40+).";
          }} else if (pSalary === 20 && agePoints < 5) {{
            pSalary = 0;
            ageMismatchMsg = isId ? 
              "Peringatan Batas Usia: Rentang gaji ¥6.000.000 – ¥7.000.000 (20 poin) memerlukan usia di bawah 40 tahun (0 poin untuk usia 40+)." :
              "Age Restriction Notice: The ¥6,000,000 – ¥7,000,000 bracket (20 pts) requires age under 40 (0 pts for age 40+).";
          }} else if (pSalary === 15 && agePoints < 10) {{
            pSalary = 0;
            ageMismatchMsg = isId ? 
              "Peringatan Batas Usia: Rentang gaji ¥5.000.000 – ¥6.000.000 (15 poin) memerlukan usia di bawah 35 tahun (0 poin untuk usia 35+)." :
              "Age Restriction Notice: The ¥5,000,000 – ¥6,000,000 bracket (15 pts) requires age under 35 (0 pts for age 35+).";
          }} else if (pSalary === 10 && agePoints < 15) {{
            pSalary = 0;
            ageMismatchMsg = isId ? 
              "Peringatan Batas Usia: Rentang gaji ¥4.000.000 – ¥5.000.000 (10 poin) memerlukan usia di bawah 30 tahun (0 poin untuk usia 30+)." :
              "Age Restriction Notice: The ¥4,000,000 – ¥5,000,000 bracket (10 pts) requires age under 30 (0 pts for age 30+).";
          }}
        }}
        if (salAlertAge) {{
          if (ageMismatchMsg) {{
            salAlertAge.style.display = "block";
            salAlertAge.textContent = ageMismatchMsg;
          }} else {{
            salAlertAge.style.display = "none";
          }}
        }}
      }}
